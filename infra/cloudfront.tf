# Origin Access Control: CloudFront signs its requests to S3 so the private bucket accepts them.
...
resource "aws_cloudfront_distribution" "site" {
  ...
  # S3 answers 403 for a missing object in a private bucket, so show the 404 page for both.
